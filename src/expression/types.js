...
export const ProjectionDefinitionType = { kind: 'projectionDefinition' };
...
export const ColorArrayType = { kind: 'colorArray' };
export const NumberArrayType = { kind: 'numberArray' };
export const ResolvedImageType = { kind: 'resolvedImage' };
export const VariableAnchorOffsetCollectionType = { kind: 'variableAnchorOffsetCollection' };
 ...
 * }
 */
export function verifyType(provided, sample) {
