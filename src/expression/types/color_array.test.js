...
describe('ColorArray', () => {
    test('ColorArray.parse', () => {
        ...
        expect(ColorArray.parse('Dennis')).toBeUndefined();
        expect(ColorArray.parse('3')).toBeUndefined();
        ...
        expect(ColorArray.parse([3, 4])).toBeUndefined();
        expect(ColorArray.parse(['non-color', 'words'])).toBeUndefined();
    ...
    test('interpolate ColorArray', () => {
        ...
        const i11nFn = (t) => ColorArray.interpolate(colorArray, targetColorArray, t);
