...
describe('NumberArray', () => {
    test('NumberArray.parse', () => {
        ...
        expect(NumberArray.parse('Dennis')).toBeUndefined();
        expect(NumberArray.parse('3')).toBeUndefined();
        expect(NumberArray.parse([3, '4'])).toBeUndefined();
    ...
    test('interpolate NumberArray', () => {
        ...
        const i11nFn = (t) => NumberArray.interpolate(numberArray, targetNumberArray, t);
